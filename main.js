...
document.getElementById("Drawn_Sktech").innerHTML = "Sktech To Be drawn" + sketch;
...
function gotResult(error, results) {
    if (error) {
        ...
        console.log(results);
        document.getElementById("Sktech_name").innerHTML = "Your Sktech = " + results[0].label;
        document.getElementById("confidence").innerHTML = "confdience = " + Math.round(results[0].confidence * 100) + "%";
    }
}
